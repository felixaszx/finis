...
void gbuffer_renderer_render(gbuffer_renderer* this, T* data)
{
    ...
    if (this->cmd_begin_cb_)
    {
        this->cmd_begin_cb_(this, data);
    }
    ...
    if (this->render_begin_cb_)
    {
        this->render_begin_cb_(this, data);
    }
    ...
    if (this->render_cb_)
    {
        this->render_cb_(this, data);
    }
    vkCmdEndRendering(this->main_cmd_);

    if (this->render_end_cb_)
    {
        this->render_end_cb_(this, data);
    }
    vkEndCommandBuffer(this->main_cmd_);
